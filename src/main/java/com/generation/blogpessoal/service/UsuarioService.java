...
public class UsuarioService {
	...
	@Autowired
	private PasswordEncoder passwordEncoder; //criptografa a senha do usuário
	
	//lista todos os usuárrios cadastrados no banco
	public List<Usuario> getAll(){ 
		return usuarioRepository.findAll();
	}
	
	//lista os usuários com id fornecido
	//é optional pois não é obrigatório
